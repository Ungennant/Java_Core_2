...
import org.serf.javacore.lesson_08.WrongInputConsoleParametersException;
...
public class ConsoleMenu {
    public static void main(String[] args) throws WrongInputConsoleParametersException {
        ...
        seasons.addAll(Arrays.asList(Season.values()));
        ...
        switch (choice) {
            ...
            case (1): {
                ...
                try {
                    for (int i = 0; i < months.size(); i++) {
                        if (months.get(i).toString().equals(monthToSearch)) {
                            count++;
                            mark = true;
                        }
                    }
            ...
            case (4): {
                ...
                try {
                    for (int i = 0; i < months.size(); i++) {
                        if (months.get(i).getDays() < month3.getDays()) {
            ...
            case (5): {
                ...
                boolean mark = false;
                for (int i = 0; i < months.size(); i++) {
                    if (months.get(i).getDays() == month2.getDays()) {
                        System.out.println(months.get(i));
                    }
                }
                break;
            ...
            case (6): {
                ...
                try {
                    for (int i = 0; i < seasons.size(); i++) {
                        if (seasons.get(i).toString().equals(seasonToSearch3)) {
                            if (i == (seasons.size() - 1)) {
            ...
            case (7): {
                ...
                try {
                    for (int i = 0; i < seasons.size(); i++) {
                        if (seasons.get(i).toString().equals(seasonToSearch4)) {
                            if (i == 0) {
